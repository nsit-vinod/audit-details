...
@RestController(value="/audit-alert-report")
public class AuditAlertReportController {
	...
	@GetMapping(path="/", params= {"stateCode"})
	...
	@GetMapping(path="/", params= {"divisionCode"})
	...
	@GetMapping(path="/", params= {"branchCode"})
	...
	@GetMapping(path="/", params= {"centreCode"})
